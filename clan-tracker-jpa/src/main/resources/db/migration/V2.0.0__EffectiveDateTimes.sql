...
alter table player_activity
    add column effective_time time without time zone;
...
update player_activity
    set
        ...
        effective_time = (date_trunc('hour', fetched_at + interval '30 minutes'))::time;
...
create index player_activity_effective_time_idx on player_activity (effective_time);

create index player_snapshot_effective_date_idx on player_snapshot (effective_date);
create index player_snapshot_effective_time_idx on player_snapshot (effective_time);